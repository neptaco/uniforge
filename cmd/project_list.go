...
Examples:
  ...
  # JSON format
  uniforge project list --output=json

  # TSV format (default for non-TTY)
  uniforge project list --output=tsv
...
func init() {
	...
	addOutputFlag(projectListCmd, &projectListFormat, "Output format: text, json, tsv (auto-detected if not specified)")
